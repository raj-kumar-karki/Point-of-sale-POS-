                            ...
                            <div class="d-flex h-100 w-100">
                                ...
                                <div class="col-5 h-100">
                                    ...
                                    <h3 class="text-light w-100 d-flex">
                                        ...
                                        <div class="col-auto flex-shrink-1 flex-grow-1 truncate-1 text-right" id="amount"><?= isset($amount) ? format_num($amount) : '0.00' ?>
                                    </div>
                                    </h3>
                                    ...
                                    <h4 class="d-flex w-100 align-items-center">
                                        ...
                                        <div class="col-8">
                                            <select name="payment_type" id="payment_type" class="form-control rounded-0" required="required">
                                                ...
                                                <option value="2" <?= isset($payment_type) && $payment_type == 2 ? "selected" : "" ?>>Online</option>
...
<tr>
    ...
    <td class="px-2 py-1 align-middle" style="line-height:.9em">
        ...
        <p class="m-0"><small class="product_price">x Rs 123.00</small></p>
    </td>
