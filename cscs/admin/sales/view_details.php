...
<div class="content py-3">
    <div class="card card-outline card-navy rounded-0 shadow">
        ...
        <div class="card-body">
            <div class="container-fluid row justify-content-center">
                <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12"  id="printout">
                  ...
                  <!--  <div class="d-flex">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="col-auto ps-1 flex-shrink-1 flex-grow-1 border-bottom border-dark"><?= isset($date_created) ? date("Y-m-d"): "" ?></div>
                        <div class="col-auto"><b>Time:</b></div>
                        <div class="col-auto ps-1 flex-shrink-1 flex-grow-1 border-bottom border-dark"><?= isset($date_created) ? date("h:i A", strtotime($date_created)): "" ?></div>
                    </div>
                    <div class="mb-2"></div>
                ...
                <!--    <div class="d-flex border-bottom border-dark">
                    ...
                    <div class="d-flex border-bottom border-dark">
                        <div class="col-2 text-center"><?= $row['qty'] ?></div>
                        <div class="col-7" style="line-height:.9em">
                            <p class="m-0"><?= $row['product'] ?> x <?= format_num($row['price']) ?></p>
                        </div>
                        <div class="col-3 text-right"><?= format_num($row['price'] * $row['qty']) ?></div>
                    </div>
            ...
            </div> <div class="row justify-content-center"><b><br>******** Thank You! ********</b></div>
            <hr>
...
<noscript id="print-header">
    ...
    <div class="d-flex w-100">
        ...
        <div class="col-8 text-center">
            ...
            <h4 class="tex-center">Jabez Cafe</h4>
