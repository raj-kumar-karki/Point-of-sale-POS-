...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand">
        <!-- Brand Logo -->      
        <a href="<?php echo base_url ?>admin" class="brand-link bg-gradient-navy text-sm">  <!-- this color change -->
        ...
        <span class="brand-text font-weight-light"><b><b><b><?php echo $_settings->info('short_name') ?></b></b></b></span>
        </a>
        <!-- Sidebar -->
